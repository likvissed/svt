...
(function (window, undef){
	...
	api.event.dnd = function (el, onHover, onDrop){
		...
		if( FileReader ){
			// Hover
			_on(el, '***REMOVED***enter ***REMOVED***leave ***REMOVED***over', onHover.ff = onHover.ff || function (evt){
				var
				...
				if( debounceTrigger ){
					...
					_id = setTimeout(function (){
						onHover.call(evt[currentTarget], _type != '***REMOVED***leave', evt);
					}, 50);
				}
			});
	...
	/**
	 * Remove ***REMOVED***'n'drop
	 * @param	{HTMLElement}	el
	 * @param	{Function}		onHover
	 * @param	{Function}		onDrop
	 */
	api.event.dnd.off = function (el, onHover, onDrop){
		_off(el, '***REMOVED***enter ***REMOVED***leave ***REMOVED***over', onHover.ff);
		...
		_send: function (options, data){
			...
			if( data.nodeName ){
				...
				if ( options._chunked ) {
					...
					xhr.onreadystatechange = function (){
						var ***REMOVED***b = parseInt(xhr.getResponseHeader('X-Last-Known-Byte'), 10);
						...
						if( xhr.readyState == 4 ){
							...
							if (!xhr.status || xhr.status - 201 > 0) {
								...
								if (((!xhr.status && !xhr.aborted) || 500 == xhr.status || 416 == xhr.status) && ++data.retry <= options.chunkUploadRetry) {
									...
									api.log("X-Last-Known-Byte: " + ***REMOVED***b);
									if (***REMOVED***b) {
										data.end = ***REMOVED***b;
									} else {
