...
* **$state:** fix $state.includes/.is to apply param types before comparisions fix(uiSref): ma ([19***REMOVED***d15](https://github.com/angular-ui/ui-router/commit/19***REMOVED***d15e3cbfff724519e9febedd05b49c75baa), closes [#1513](https://github.com/angular-ui/ui-router/issues/1513))
...
* **$urlMatcherFactory:**
  ...
  * fix encoding slashes in params ([0c983a08](https://github.com/angular-ui/ui-router/commit/0c983a08e2947f9996835***REMOVED***77debd73038e95cf), closes [#1119](https://github.com/angular-ui/ui-router/issues/1119))
...
* **$state:**
  ...
  * sanity-check state lookups ([456fd5ae](https://github.com/angular-ui/ui-router/commit/456fd5aec9ea507518927bfabd62b4afad4cf***REMOVED***), closes [#980](https://github.com/angular-ui/ui-router/issues/980))
...
* **$urlRouter:**
  ...
  * force URLs to have valid params ([d48505cd](https://github.com/angular-ui/ui-router/commit/d48505cd328d83e39d5706e085ba319***REMOVED***f999a6))
...
* **$state:** use $browser.baseHref() when generating urls with .href() ([cbcc8488](https://github.com/angular-ui/ui-router/commit/cbcc84887d6b6d35258adabb97c***REMOVED***cd9c1e272d))
