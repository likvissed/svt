...
setDocument = Sizzle.setDocument = function( node ) {
	...
	function( a, b ) {
		...
		// Wa***REMOVED*** down the tree looking for a discrepancy
		while ( ap[i] === bp[i] ) {
			i++;
		}
...
var access = function( elems, fn, key, value, chainable, emptyGet, raw ) {
	...
	// Sets one value
		...
		if ( bu***REMOVED*** ) {
			...
			// Bu***REMOVED*** operations run against the entire set
			if ( raw ) {
				fn.call( elems, value );
				fn = null;
			...
			// ...except when executing function values
				...
				fn = function( elem, key, value ) {
					return bu***REMOVED***.call( jQuery( elem ), value );
				};
			}
		}
...
var
	rkeyEvent = /^key/,
	rmouseEvent = /^(?:mouse|pointer|contextmenu|***REMOVED***|drop)|click/,
	rtypenamespace = /^([^.]*)(?:\.(.+)|)/;
...
jQuery.event = {
	...
	handlers: function( event, handlers ) {
		...
		if ( delegateCount &&
			...
			// Support: Firefox <=42
			// Suppress spec-***REMOVED***ting clicks indicating a non-primary pointer button (trac-3861)
...
// which is spec ***REMOVED***tion - http://www.w3.org/TR/DOM-Level-3-Events/#events-focusevent-event-order
