...
ColReorder adds the ability for the end user to click and ***REMOVED*** column headers to reorder a table as they see fit, to DataTables. Key features include:
