...
var ColReorder = function( dt, opts )
{
	...
	this.s = {
		...
		/**
		 * @namespace Information used for the mouse ***REMOVED***
		 */
		"mouse": {
			"startX": -1,
			"startY": -1,
...
ColReorder.prototype = {
	...
	"_fnConstruct": function ()
	{
		...
		/* Add event handlers for the ***REMOVED*** and drop, and also mark the original column order */
		for ( i = 0; i < iLen; i++ )
		{
	 ...
	 *  @param   element nTh TH element to be ***REMOVED***ged
	 *  @returns void
	 *  @private
	 */
	...
	/**
	 * Deal with a mouse move event while ***REMOVED***ging a node
	 *  @method  _fnMouseMove
	 *  @param   event e Mouse event
	 *  @returns void
	 *  @private
	...
	"_fnMouseMove": function ( e )
	{
		...
		if ( this.dom.***REMOVED*** === null )
		{
			/* Only create the ***REMOVED*** element if the mouse has moved a specific distance from the start
			 * point - this allows the user to make small mouse movements when sorting and not have a
			 * possibly confusing ***REMOVED*** element showing up
			 */
			if ( Math.pow(
	...
	/**
	 * Finish off the mouse ***REMOVED*** and insert the column where needed
	 *  @method  _fnMouseUp
	 *  @param   event e Mouse event
	 *  @returns void
	 *  @private
	...
	"_fnMouseUp": function ( e )
	{
		...
		if ( this.dom.***REMOVED*** !== null )
		{
			...
			this.dom.***REMOVED***.remove();
			this.dom.pointer.remove();
			this.dom.***REMOVED*** = null;
	...
	"_fnRegions": function ()
	{
		...
		/* Disallow columns for being reordered by ***REMOVED*** and drop, counting right to left */
		if ( this.s.fixedRight !== 0 )
		{
			this.s.aoTargets.splice( this.s.aoTargets.length - this.s.fixedRight );
		}

		/* Disallow columns for being reordered by ***REMOVED*** and drop, counting left to right */
		if ( this.s.fixed !== 0 )
		{
	...
	/**
	 * Copy the TH element that is being ***REMOVED***s so the user has the idea that they are actually
	...
	"_fnCreateDragNode": function ()
	{
		...
		this.dom.***REMOVED*** = $(origTable.cloneNode(false))
