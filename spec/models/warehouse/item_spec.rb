...
module Warehouse
  RSpec.describe Item, type: :model do
    ...
    it { is_expected.to have_many(:binders).class_name('Warehouse::Binder').dependent(:destroy).with_foreign_key('warehouse_item_id')}
    it { is_expected.to have_many(:signs).through(:binders).class_name('Invent::Sign') }
