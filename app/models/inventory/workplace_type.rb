module Inventory
  class WorkplaceType < Invent
    ...
    DESCR = {
      rm_pk:        "Стационарное рабочее место включает в себя системный блок (неттоп) или моноблок с подключенными к
нему периферийными устройствами. В состав одного рабочего место может входить только один компьютер.",
