(function() {
  ...
  function ngWarehouseItemSupplyPopover($compile) {
    return {
      restrict: 'E',
      template: '<i class="fa fa-truck fa-fw pointer" uib-tooltip="Просмотреть список поставок" uib-popover-template="\'myPopoverTemplate.html\'" popover-title="Список поставок: {{item.item_type}}" popover-placement="right"></i>',
    }
  }
