...
app
  ...
  .config([
    'uibPaginationConfig', 'Config', function(uibPaginationConfig, Config) {
  ...
  .config([
    'uibDatepickerConfig', 'Config', function(uibDatepickerConfig, Config) {
    uibDatepickerConfig.showWeeks = Config.global.uibDatepickerPopupConfig.showWeeks;
    }
  ])
  .config([
    'uibDatepickerPopupConfig', 'Config', function(uibDatepickerPopupConfig, Config) {
